...
public class JFXCircle implements Circle {
    ...
    public void setPosition(int centerX, int centerY) {
        fxCircle.setCenterX(centerX);
        fxCircle.setCenterY(centerY);
    }

    @Override
    public void setRadius(int radius) {
        fxCircle.setRadius(radius);
    }

    @Override
    public int[] getPosition() {
        return new int[]{(int) fxCircle.getCenterX(), (int) fxCircle.getCenterY()};
    }

    @Override
    public int getRadius() {
        return (int) fxCircle.getRadius();
    }
}
